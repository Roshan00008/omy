...
// Find the closing brace before exports
...
const newContent = content.slice(0, insertPoint + 1) + newScrapers + content.slice(insertPoint + 1);
fs.writeFileSync(file, newContent);
console.log('Added MMSBee and DesiPapa scrapers');
